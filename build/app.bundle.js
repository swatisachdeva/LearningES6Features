...
var ObjectFormatter = function () {
    ...
    _createClass(ObjectFormatter, null, [{
        ...
        value: function format(obj) {
            ...
            if (obj) {
                for (var prop in obj) {
                    var validation = obj[prop] && typeof obj[prop] !== 'function';
...
var _formatutils = __webpack_require__(0);
...
var ORDERS_SYMBOL = Symbol('Orders Symbol');
...
var Customer = function () {
    ...
    _createClass(Customer, [{
        ...
        value: regeneratorRuntime.mark(function value() {
            var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, order;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.prev = 3;
                            _iterator = this[ORDERS_SYMBOL][Symbol.iterator]();
        ...
        value: function createCustomer(csvString) {
            ...
            if (csvString) {
                var splittedSting = csvString.split(COL_SEPARATOR);

                // Spread parameter
                customer = new (Function.prototype.bind.apply(Customer, [null].concat(_toConsumableArray(splittedSting))))();
            }
            return customer;
        }
    }]);
...
var Order = function () {
    function Order(orderId, orderDate, amonut) {
        _classCallCheck(this, Order);

        var _arguments = Array.prototype.slice.call(arguments);

        this.orderId = _arguments[0];
        this.orderDate = _arguments[1];
        this.amonut = _arguments[2];
    }
...
var _internetcustomer = __webpack_require__(6);

var _customer = __webpack_require__(1);

var _order2 = __webpack_require__(2);

var _arrowfunctions = __webpack_require__(5);

var _withoutpromises = __webpack_require__(7);

var _withpromises = __webpack_require__(8);

var PromiseWorkers = _interopRequireWildcard(_withpromises);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var customer = new _internetcustomer.InternetCustomer(10, 'Swati', 'New Delhi', 12000, true, 'http://blogs.msdn.com/nwt');

console.log(customer.format());
console.log(customer instanceof _internetcustomer.InternetCustomer);

var customerCsvString = '10,Swati,New Delhi, 12000,true';
...
anotherCustomer.addOrder(new _order2.Order(1, new Date(), 12000));
anotherCustomer.addOrder(new _order2.Order(2, new Date(), 10000));
anotherCustomer.addOrder(new _order2.Order(3, new Date(), 22000));
anotherCustomer.addOrder(new _order2.Order(4, new Date(), 32000));
...
try {
    for (var _iterator = anotherCustomer.getOrders()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
try {
    for (var _iterator2 = anotherCustomer[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var _order = _step2.value;

        console.info(_order.toString());
    }
} catch (err) {
...
var dataProcessor = new _arrowfunctions.DataProcessor();
var result = dataProcessor.process(function (a, b) {
    return a + b;
}, function (a, b) {
    return a - b;
}, function (a, b) {
...
//Async threads
var worker1 = new _withoutpromises.HeavyWorker();
var worker2 = new _withoutpromises.HeavyWorker2();

worker1.doHeavyWork(10, function (result) {
    console.log('Worker 1 completed .. ' + new Date() + JSON.stringify(result));

    worker2.doHeavyWork(300, function (result) {
        console.log('Worker 2 completed .. ' + new Date() + JSON.stringify(result));
    });
});

//With promise
var promiseWorker1 = new PromiseWorkers.HeavyWorker();
var promiseWorker2 = new PromiseWorkers.HeavyWorker2();
var input = 200;

Promise.all([promiseWorker1.process(input), promiseWorker2.process(input)]).then(function (data) {
    return console.log('Both successfully completed .. ' + new Date() + JSON.stringify(data));
}, function (error) {
    return console.log('One of the workers failed .. ' + new Date() + JSON.stringify(error));
});
...
var HeavyWorker = function () {
    function HeavyWorker() {
        _classCallCheck(this, HeavyWorker);
    }

    _createClass(HeavyWorker, [{
        key: 'doHeavyWork',
        value: function doHeavyWork(input, callback) {
            setTimeout(function () {
                var status = 'Failed';
...
var HeavyWorker2 = function () {
    function HeavyWorker2() {
        _classCallCheck(this, HeavyWorker2);
    }

    _createClass(HeavyWorker2, [{
        key: 'doHeavyWork',
        value: function doHeavyWork(input, callback) {
            setTimeout(function () {
                var status = 'Failed';
...
exports.HeavyWorker = HeavyWorker;
exports.HeavyWorker2 = HeavyWorker2;
    ...
    _createClass(HeavyWorker, [{
        ...
        value: function process(input) {
            var workerPromise = new Promise(function (resolve, reject) {
                setTimeout(function () {
                    var status = input >= VALID_VALUE ? SUCCESS : FAILED;
                    if (status === SUCCESS) {
